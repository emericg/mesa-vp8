...
void vp8_loop_filter_horizontal_edge_c(unsigned char *s,
                                       int p, /* pitch */
...
void vp8_loop_filter_vertical_edge_c(unsigned char *s,
                                     int p,
                                     const unsigned char *blimit,
                                     const unsigned char *limit,
                                     const unsigned char *thresh,
...
static __inline void vp8_mbfilter(signed char mask, uc hev, uc *op2, uc *op1, uc *op0, uc *oq0, uc *oq1, uc *oq2)
{
    signed char s, u;
    signed char vp8_filter, Filter1, Filter2;
...
void vp8_mbloop_filter_horizontal_edge_c(unsigned char *s,
                                         int p,
                                         const unsigned char *blimit,
                                         const unsigned char *limit,
                                         const unsigned char *thresh,
...
void vp8_mbloop_filter_vertical_edge_c(unsigned char *s,
                                       int p,
                                       const unsigned char *blimit,
                                       const unsigned char *limit,
                                       const unsigned char *thresh,
...
void vp8_loop_filter_simple_horizontal_edge_c(unsigned char *s,
                                              int p,
                                              const unsigned char *blimit)
{
    signed char mask = 0;
...
void vp8_loop_filter_simple_vertical_edge_c(unsigned char *s,
                                            int p,
                                            const unsigned char *blimit)
{
    signed char mask = 0;
